# Compliance Knowledge Portal with Source Citations and Admin-Ready Backend - Advanced Simple RAG
...
```text
ai-simple-rag-compliance-knowledge-portal-with-source-citations-and-admin-ready-backend/
  backend/
    app/
      main.py
      config.py
